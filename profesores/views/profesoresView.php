...
require_once($raiz.'/profesores/models/ClienteModel.php'); 
require_once($raiz.'/profesores/models/TipoContribuyenteModel.php'); 
 ...
 public function clientesMenu($clientes)
 {
    ...
    <div style="padding:5px;">
        <div class="row">
            ...
            <div class="col-lg-3">
                <select id = "idCliente" name="idCliente" onchange="listarProfesoresFiltradoDesdeClientes();" class="form-control" >
     ...
     ?>
         ...
         <div class="modal-dialog">
             ...
             <div class="modal-header">
                 <h1 class="modal-title fs-5" id="exampleModalLabel">Info Profesor</h1>
             ...
             <div class="modal-footer">
                 <button  type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="listarProfesores();" >Cerrar</button>
                 <button  type="button" class="btn btn-primary"  id="btnEnviar"  onclick="grabarProfesor();" >Grabar  </button>
             </div>
             </div>
         </div>
         </div>
