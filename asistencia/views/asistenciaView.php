...
// require_once($raiz.'/alumnos/models/TipoContribuyenteModel.php'); 
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <select id = "idCliente" name="idCliente" onchange="listarClienteFiltradoDesdeClientes();" class="form-control" >
                       <option value="-1">Seleccionar Alumno</option>
                       <?php  
     ...
     ?>
         ...
         <div class="modal-dialog">
             ...
             <div class="modal-header">
                 <h1 class="modal-title fs-5" id="exampleModalLabel">Info Alumno</h1>
             ...
             <div class="modal-footer">
                 ...
                 <button  type="button" class="btn btn-primary"  id="btnEnviar"  onclick="grabarCliente();" >Grabar Alumno</button>
             </div>
             </div>
         </div>
         </div>
